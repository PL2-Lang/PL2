...
#define PL2_EDITION       "PL2-A"
#define PL2_EDITION_CN    "霹雳 2 乙"
#define PL2A_VER_MAJOR    0        /* Major version of PL2A */
#define PL2A_VER_MINOR    1        /* Minor version of PL2A */
#define PL2A_VER_PATCH    0        /* Patch version of PL2A */
#define PL2A_VER_POSTFIX  "alpha"  /* Version postfix */
...
typedef enum e_pl2a_error_code {
  ...
  PL2A_ERR_PARTBUF        = 2,  /* part buffer exceeded */
  ...
  PL2A_ERR_UNKNWON_CMD    = 10, /* unknown command */
...
#define PL2A_EMPTY_PART(part) \
  (pl2a_isNullSlice((part)->prefix) && pl2a_isNullSlice((part)->body))
...
_Bool pl2a_isCompatible(pl2a_SemVer ver1, pl2a_SemVer ver2);
...
#define PL2A_EMPTY_CMD(cmd) ((cmd)->cmdName == 0 && (cmd)->stub == 0)
